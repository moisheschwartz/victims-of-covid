    ...
    return (
        <>
            ...
            <div style={{ padding: "12px 20px", width: "100%", backgroundColor: "teal", textAlign: "center", justifyContent: "space-around", color: "#fff" }}>
                <div>Crested by Moishe Schwartz. <br />Suggestions, Comments or anything else please email <a style={{ color: "#fff" }} href="mailto:mosesschwartzdev@gmail.com">mosesschwartzdev@gmail.com</a></div>
            </div>
        </>
    )
}
